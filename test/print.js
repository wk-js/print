...
const { WarnCategory } = require('../js/categories/warn')
const { DateExtension } = require( '../js/extensions/date' )
const { StyleExtension } = require( '../js/extensions/style' )
const { TagExtension } = require( '../js/extensions/tag' )
...
// p.config.category(DebugCategory)

// p.config.display('log', false)
// p.config.display('debug', false)
